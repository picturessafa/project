...
public class fg_four_coupon extends FragmentActivity{
    //定义FragmentTabHost对象
    ...
    //定义数组来存放Fragment界面
    private Class fragmentArray[] = {coupon_unused.class, coupon_used.class};
    private ImageView couponbtn;
    //Tab选项卡的文字
    private String mTextviewArray[] = {"店铺优惠券", "现金劵"};
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.fg_four_coupon);
        couponbtn= (ImageView) findViewById(R.id.couponbtn);
